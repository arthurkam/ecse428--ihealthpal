      ...
      <div class="row">
        <h2>About Us</h2>
         <div style="height: 500px;">
            ...
            <p>weight, exercise, and much more. Each person that opens an account will get their own profile, but will also be provided</p>
            <p>with the option to share some information with key people such as their personal trainer, nutritionist, doctor, etc. </p>
            <p>Once logged in, visuals will help monitor the various health and fitness indicators. Tools for controlling access to </p>
